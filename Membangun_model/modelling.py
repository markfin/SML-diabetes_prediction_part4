...
mlflow.set_experiment("Diabetes Prediction Model Training")

# Enable MLflow autologging
mlflow.autolog()

# Define paths relative to the script's execution environment
# Assuming modelling.py is in 'Membangun_model' and processed_diabetes.csv is in 'SML-diabetes_prediction_part4'
